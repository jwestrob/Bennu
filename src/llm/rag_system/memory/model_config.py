...
class ModelConfigManager:
    ...
    def set_optimized_mode(self):
        ...
        Uses gpt-5-mini-2025-08-07 for most tasks, gpt-5-2025-08-07 only for complex synthesis.
        ...
        logger.info("🎯 Switched to OPTIMIZED mode: gpt-5-mini-2025-08-07 for most tasks, gpt-5-2025-08-07 for synthesis")
    ...
    def set_premium_mode(self):
        ...
        Uses gpt-5-2025-08-07 for all tasks. Maximum quality but highest cost.
        """
        self.allocator.switch_to_premium_mode()
        self.current_mode = "premium"
        logger.info("🔥 Switched to PREMIUM mode: gpt-5-2025-08-07 for all tasks (maximum quality, highest cost)")
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        if summary['mode'] == 'optimized':
            ...
            status["primary_models"] = {
                "simple_tasks": "gpt-5-mini-2025-08-07",
...
def quick_switch_to_o3():
    """Quick switch to premium mode - for when you need maximum quality."""
    print("🔥 Switching to premium mode for maximum quality...")
    set_premium_mode()
    print_model_status()
