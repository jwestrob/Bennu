...
class Neo4jBulkLoader:
    ...
    def _create_constraints_and_indexes(self):
        ...
        statements = get_post_import_statements()
...
def get_post_import_statements() -> list[str]:
    """Return the exact set of constraints and indexes we apply post-import.

    Used by export tooling to generate scripts/post_import.cypher deterministically.
    """
    return [
